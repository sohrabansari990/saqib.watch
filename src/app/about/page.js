                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            ...
                            <p className="text-gray-400 leading-relaxed mb-6 text-lg">
                                Born from a passion for precision and a commitment to elegance, Saqib Watches has been a hallmark of luxury watchmaking for over four decades. From our humble beginnings in Dubai to becoming a global icon, our journey is defined by the relentless pursuit of perfection.
                            </p>
                            <p className="text-gray-400 leading-relaxed text-lg">
                                Each Saqib timepiece is more than just a watch; it's a testament to the artistry of horology. We blend traditional craftsmanship with modern innovation to create pieces that transcend generations.
                            </p>
                        </motion.div>
                        <motion.div
